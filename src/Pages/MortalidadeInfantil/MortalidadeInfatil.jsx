    ...
    <div className={styles.mortalidadeContainer}>
      ...
      <div className={styles.odsContainer}>
        ...
        <div className={styles.odsText}>
          ...
          <h3>
            O Brasil precisa, até 2030, enfrentar as mortes evitáveis de recém-nascidos e crianças menores de 5 anos, objetivando reduzir a:
          </h3>
          <ul>
            <li>taxa da mortalidade infantil para no máximo 5 por 1.000 nascidos vivos </li>
            <li>e a mortalidade na infância para no máximo 8 por 1.000 nascidos vivos.</li>
          </ul>
        </div>
      </div>
      ...
      <div className={styles.dataContainer}>
        <div className={styles.dataImage}>
          ...
          <p>Taxa de Mortalidade Infantil (por mil Nascidos Vivos). Regiões, 1990 a 2019</p>
          <h2>Essa queda normalmente é atribuída a:</h2>
        </div>

        <div className={styles.dataText}>
          <p className={styles.dataText1}>
            A mortalidade infantil é um importante indicador de saúde e condições de vida de uma população.
          </p>
          <p className={styles.dataText2}>
            No Brasil, vem-se observando um declínio na taxa de mortalidade nesse grupo.
          </p>
        </div>
      </div>
      ...
      <div className={styles.gridWrapper}>
        <div className={styles.gridContainer}>
          <div className={styles.gridItem}>
            <a href='https://www.scielo.br/j/csp/a/CGMbDPr4FL5qYQCpPKSVQpC/?lang=pt' target='_blank'><img src={icon1} alt="Ícone 1" /></a>
            <p>Acesso Pré-Natal</p>
          </div>
          <div className={styles.gridItem}>
            <a href='https://www.gov.br/saude/pt-br/assuntos/saude-de-a-a-z/a/aleitamento-materno#:~:text=O%20aleitamento%20materno%20%C3%A9%20uma,ch%C3%A1s%2C%20%C3%A1gua%20e%20outros%20alimentos.' target='_blank'><img src={icon2} alt="Ícone 2" /></a>
            <p>Promoção do aleitamento materno</p>
          </div>
          <div className={styles.gridItem}>
            <a href='https://www.gov.br/saude/pt-br/vacinacao/calendario' target='_blank'><img src={icon3} alt="Ícone 3" /></a>
            <p>Cobertura vacinal</p>
          </div>
          <div className={styles.gridItem}>
            <a href='https://institutoneurosaber.com.br/como-acompanhar-o-desenvolvimento-infantil/' target='_blank'><img src={icon4} alt="Ícone 4" /></a>
            <p>Acompanhamento do desenvolvimento da criança</p>
          </div>
          <div className={styles.gridItem}>
            <a href='https://www.gov.br/saude/pt-br/composicao/saps' target='_blank'><img src={icon5} alt="Ícone 5" /></a>
            <p>Atenção primária na saúde</p>
          </div>
          <div className={styles.gridItem}>
            <a href='https://agenciadenoticias.ibge.gov.br/agencia-sala-de-imprensa/2013-agencia-de-noticias/releases/13100-asi-aumento-da-escolaridade-feminina-reduz-fecundidade-e-mortalidade-infantil' target='_blank'><img src={icon6} alt="Ícone 6" /></a>
      ...
      <div className={styles.dataContainer2}>
        <div className={styles.dataBox1}>
          <p>Taxa de mortalidade infantil (menores de um ano de idade) - 2019 (para cada mil nascidos vivos)</p>
          <img src={dado2} alt="dado2"></img></div>
          <div className={styles.dataBox2}>
          <p>Taxa de mortalidade na infância (menores de um cinco de idade) - 2019 (para cada mil nascidos vivos)</p>
          <img src={dado3} alt="dado3"></img></div>
        </div>
