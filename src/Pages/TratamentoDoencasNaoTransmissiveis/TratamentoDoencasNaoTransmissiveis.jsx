    ...
    <div className={styles.TratamentoDoencasNaoTransmissiveisContainer}>
      <div className={styles.bannerContainer}>
        ...
        <div className={styles.tituloBanner}>
          ...
          menos uma <br></br>das doenças crônicas não transmissíveis (DCNT)
        </div>
      </div>
      ...
      <div className={styles.odsContainer}>
        ...
        <div className={styles.odsText}>
          ...
          <h3>
            ...
            não transmissíveis via prevenção e tratamento, promover a saúde
            mental e o bem-estar, a saúde do trabalhador e da trabalhadora, e
            prevenir o suicídio, alterando significativamente a tendência de
            aumento.
          </h3>
        </div>
      </div>
      ...
      <div className={styles.info1}>
        ...
        <div className={styles.divinfo1}>
          ...
          <div className={styles.txtinfo1}>
            <h2>
              As doenças crônicas são aquelas que apresentam início gradual, com
      ...
      <div className={styles.grafContainer}>
        <div className={styles.grafPizza}>
          <img
            className={styles.imgGrafPizza}
            src={grafpizza}
            alt="grafico de pizza"
          />
          <p>
            69% das mortes ocorridas no Brasil em 2016 <br /> foram por doenças
            crônicas não <br /> transmissíveis.
          </p>
        </div>

        <div className={styles.info2}>
          <p>
            Maior alerta é na faixa de 30 a 69 anos, quando maioria das mortes
        ...
        <div className={styles.grafLinha}>
          <img
            className={styles.imggrafLinha}
            src={graflinha}
            alt="grafico de Linha"
          />
        </div>
      </div>
      ...
      <div className={styles.boxDoencas}>
        <div>
          <h2 className={styles.txtDoencas}>AGENTES CAUSADORES</h2>
        </div>
        ...
        <div className={styles.Doencas}>
          ...
          <div className={styles.blockIcons}>
            ...
            <div>
              <h3>
                Condições Mentais <br /> e Neurológicas
              </h3>
            </div>
          </div>
      ...
      <div className={styles.boxDoencas}>
        <div>
          <h2 className={styles.txtDoencas}>FATORES DE RISCO</h2>
        </div>
      ...
      <div className={styles.boxInfo3}>
        <div className={styles.tituloInfo3}>
          {" "}
          <p>O Bem-Estar</p>
        </div>

        <div className={styles.box1}>
          <div className={styles.box1txt}>
            <p>
        ...
        <div className={styles.bloco1}>
          ...
          <div className={styles.txtbloco1}>
        ...
        <div className={styles.bloco2}>
          ...
          <div className={styles.txtbloco1}>
            Está relacionado a condições <br /> monetárias.
          </div>
        </div>
        ...
        <div className={styles.bloco4}>
          ...
          <div className={styles.txtbloco1}>
            É o equilíbrio de sentimentos e <br />
            emoções e o <br />
            controle sobre eles.
          </div>
        </div>
      ...
      <div className={styles.boxinfo4}>
        <div className={styles.tituloinfo4}>
          <p>Superheroína: A Tecnologia!</p>
        </div>
        <img className={styles.relogio} src={relogio} alt="relogio" />
        <div className={styles.info4txt}>
          <p>
            + monitoramento da própria saúde <br /> + alimentação saudável{" "}
            <br /> + exercícios <br /> + registros de condições <br />{" "}
            <h4> = Prevenção de doenças e melhoria no tratamento e cuidado!</h4>
          </p>
        </div>
      </div>
    </div>
