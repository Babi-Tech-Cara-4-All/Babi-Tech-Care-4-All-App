    ...
    <div className={styles.DoencaTransmissiveisContainer}>
      ...
      <div className={styles.Banner}>
        <img src={BannerDT} alt="Banner" />
          <div className={styles.tituloBanner}>
             Doenças transmissíveis, como tuberculose, HIV, malária e hepatite B, <br />ainda causam quase metade das mortes em países de baixa e média renda.
          </div>
      </div>
      ...
      <div className={styles.odsContainer}>
        ...
        <div className={styles.odsText}>
          ...
          <h3>Até 2030, acabar com as epidemias de AIDS, tuberculose, malária e doenças tropicais negligenciadas, e combater a hepatite, doenças transmitidas pela água, e outras doenças transmissíveis.</h3>
        </div>
      ...
      <div className={styles.boxMortalidades}>
        <div><h2 className={styles.txtMortalidades}>Principais doenças transmissiveis e motalidades</h2></div>
      ...
      <div className={styles.boxCausas}>
        <div><h2 className={styles.txtCausas}>AGENTES CAUSADORES</h2></div>
...
<div className={styles.boxDesigualdade}>
  ...
  <div className={styles.Mulher}>
    ...
    <div  className={styles.balaoMulher}>
            ...
            <div div className={styles.balao}>

                <div className={styles.txtBalao}>
                      <p>Em um mundo de avanços em saúde, a desigualdade persistente nos lembra da necessidade urgente de garantir que cada vida conte</p>
               </div>
    ...
    <div className={styles.txtMulher}>
          <ul>
            <li>Em muitos países, a realização de testes para HIV é substancialmente mais baixa entre populações empobrecidas, mal-educadas ou em áreas rurais. </li>
            <br />
            <li>Jovens mulheres (15-24 anos) na Região Africana da OMS têm maior risco de infecção por HIV do que seus colegas masculinos.</li>
            <br />
            <li>Globalmente, os homens são menos propensos a fazer o teste de HIV ou receber terapia antirretroviral.</li>
          </ul>
    </div>
  ...
  <div className={styles.dados}>
    <div>
      ...
      <figcaption>Estimated numbers of people (all ages) living with HIV, 2020</figcaption>
    </div>
    

    <div>
      <img className={styles.grafico} src={grafico} alt="grafico" />
      <figcaption>New HIV infections (per 1000 uninfected population), by WHO region and global, 2000–2020</figcaption>
    </div>
