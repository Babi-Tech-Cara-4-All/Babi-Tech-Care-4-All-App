  ...
  return (
    ...
    <div className={styles.bodyPageTime}>
      ...
      <div className={styles.timeMembers}>
        <MemberCard img={lucia} nome="Lúcia Boutti" link="https://www.linkedin.com/in/lucyboutti/"/>
        <MemberCard img={maria} nome="Maria Clara" link="https://www.linkedin.com/in/maria-clara-818710226/"/>
        <MemberCard img={thiago} nome="Thiago Eiji" link="https://www.linkedin.com/in/thiago-eiji-matumoto/"/>
        <MemberCard img={miguel} nome="Miguel Lima" link="https://www.linkedin.com/in/miguel-lima-259a371a2/"/>
      </div>
    </div>
  </section>
  )
